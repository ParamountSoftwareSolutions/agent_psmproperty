...
Route::get('property-manager/webhook/users', 'App\Http\Controllers\PropertyManager\WebHookController@testuser')->name('webhook.users');
Route::post('/webhook/addFbLead', 'App\Http\Controllers\PropertyManager\WebHookController@addfblead')->name('webhook.addfblead');
...
Route::group(['middleware' => ['auth:web', 'isAdmin'], 'namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    /* Society Admin */
    Route::post('society_admin/password/update/{society_admin}', 'SocietyyAdminController@updatePassword')->name('society_admin.password.update');
    ...
    /* Property Admin */
    Route::post('property_admin/password/update/{property_admin}', 'PropertyAdminController@updatePassword')->name('property_admin.password.update');
...
Route::group(['as' => 'property.'], function () {
    Route::group(['middleware' => ['auth:web', 'isPropertyAdmin'], 'namespace' => 'Property', 'prefix' => 'property'], function () {
        ...
        Route::get('property_manager/deactivate/{manager}', 'ManagerController@deactivate')->name('manager.deactivate');
