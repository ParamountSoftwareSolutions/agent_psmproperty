...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $user->save();
        if ($user) {
            return redirect()->route('admin.profile.index')->with($this->message('Profile Update Successfully', 'success'));
        } else {
    ...
    public function updatePassword(Request $request)
    {
        ...
        if (Hash::check($request->old_password, $user->password)) {
            ...
            return redirect()->route('admin.profile.index')->with($this->message("Update Password Successfully", 'success'));
        } else {
