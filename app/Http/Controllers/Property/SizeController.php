...
class SizeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('property.size.index', compact('size'));
    }
    ...
    {
        return view('property.size.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($size) {
            ...
            return redirect()->route('property.size.index')->with($this->message('Size Create SuccessFully', 'success'));
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('property.size.edit', compact('size'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $size->save();
        if ($size) {
            return redirect()->route('property.size.index')->with($this->message('Building update SuccessFully', 'success'));
        } else {
    ...
    public function destroy($id)
    {
        ...
        $size->delete();
        if ($size) {
            return redirect()->route('property.size.index')->with($this->message('Size delete SuccessFully', 'success'));
        } else {
