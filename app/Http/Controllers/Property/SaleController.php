...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($sale) {
            return redirect()->route('property.sale.index')->with($this->message('Property Sale Create Successfully', 'success'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($sale) {
            return redirect()->route('property.sale.index')->with($this->message('Property Sale Update Successfully', 'success'));
        } else {
            return redirect()->back()->with($this->message('Property Sale Receipt Create Error', 'danger'));
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $sale->delete();
        if ($sale) {
            return redirect()->route('property.sale.index')->with($this->message('Property Sale Delete Successfully', 'success'));
        } else {
