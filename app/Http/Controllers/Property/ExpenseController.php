...
class ExpenseController extends Controller
{
    ...
    {
        $expenses = BuildingExpense::with('building', 'labor')->get();
        return view('property.expense.index', compact('expenses'));
    }
    ...
    public function create()
    {
        ...
        return view('property.expense.create', compact('building'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($expense){
            return redirect()->route('property.expense.index')->with(['alert' => 'success', 'message' =>  'Expense Create Successfully']);
        } else{
    ...
    public function edit($id)
    {
        ...
        $building = Helpers::building_detail();
        return view('property.expense.edit', compact('expense', 'building'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($expense){
            return redirect()->route('property.expense.index')->with(['alert' => 'success', 'message' => 'Expense Update Successfully']);
        } else{
    ...
    public function generatePDF(Request $request)
    {
        ...
        /*$pdf = PDF::loadView('property.pdf.expense_report', $expense);
