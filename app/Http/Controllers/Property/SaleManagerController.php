...
class SaleManagerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sale_manager->property_admin_id = Helpers::user_admin();
        $sale_manager->save();
        ...
        if ($sale_manager) {
            return redirect()->route('property.sale_manager.index')->with($this->message('Sale Manager Create Successfully', 'success'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($sale_manager) {
            return redirect()->route('property.sale_manager.index')->with($this->message('Sale Manager Update Successfully', 'success'));
        } else {
    ...
    public function destroy($id)
    {
        ...
        if ($user) {
            return redirect()->route('property.sale_manager.index')->with($this->message('Sale Manager Delete SuccessFully', 'success'));
        } else {
    ...
    public function activate($id)
    {
        ...
        if ($user->status == 0) {
            $user->status = 1;
            $user->save();
            return redirect()->route('property.sale_manager.index')->with($this->message("Sale Manager Activate Successfully", 'success'));
        } else {
    ...
    public function deactivate($id)
    {
        ...
        if ($user->status == 1) {
            $user->status = 0;
            $user->save();
            return redirect()->route('property.sale_manager.index')->with($this->message("Sale Manager DeActivate Successfully", 'success'));
        } else {
