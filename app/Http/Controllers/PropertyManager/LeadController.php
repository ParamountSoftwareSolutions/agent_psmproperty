...
class LeadController extends Controller
{
    ...
    public function index()
    {
        ...
        $sales_details = BuildingSale::with('building_sale_history');
    ...
    public function block($panel, $building_id)
    {
        $building = Helpers::building_detail_single($building_id);
        $inventories = BuildingInventory::where('building_id',$building_id)->get();
...
//            'source' => 'required',
    ...
    public function edit($panel, $id)
    {
        ...
        return view('property_manager.sale.lead.edit', compact('building_sale', 'building_sale', 'building', 'sales_person', 'country'));
    }
