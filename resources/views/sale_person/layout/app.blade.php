...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        @include('sale_person.includes.header')
        @include('admin.includes.aside')
        @yield('content')
        @include('sale_person.includes.footer')
    </div>
</div>
<!-- General JS Scripts -->
...
<script>
    $(document).ready(function () {
        $(document).on('click', '#notification-mark-read',function () {
            $.ajax({
                url: "{{ url('sale-person/notification/mark/read') }}",
                type: "GET",
                dataType: "json",
                success: function (data) {
                    /*console.log(data);*/
        ...
        $(document).on("click", "#notification-mark-single-read", function(e){
            ...
            console.log(id);
            $.ajax({
                url: "{{ url('sale-person/notification/mark/single/read/') }}"+ '/' + id,
                type: "GET",
                dataType: "json",
                success: function (data) {
                    pauseAudio();
     ...
     //       $.ajax({
     //           url: "{{ url('sale-person/notifications/latest') }}",
     //           type: "GET",
     //           dataType: "json",
     //           success: function (data) {
     //               console.log(data)
