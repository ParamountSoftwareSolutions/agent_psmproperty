                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">@if ($errors->any())
                            ...
                            @endif
                            <form method="post" action="{{ route('property.category.store') }}">
                                @csrf
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($category as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->category }}</td>
                                                <td>
                                                    <a href="{{ route('property.category.edit', ['category' => $data->id]) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('property.category.destroy', ['category' => $data->id]) }}"
