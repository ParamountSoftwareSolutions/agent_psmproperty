            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form method="post" action="{{ route('property.setting.update_server_key') }}" autocomplete="off">
                                @csrf
                        ...
                        <div class="card">
                            <form method="post" action="{{ route('property.setting.update_push_notification') }}" autocomplete="off">
                                @csrf
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        @php($sl=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'sale_lost'])->first()->value)
                                        @php($data=json_decode($sl,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        <input type="checkbox" name="sale_lost_status" {{$data['status']==1?'checked':''}} class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Sale Lost Message</span>
                                                    </label>
                                                </div>
                                                <textarea name="sale_lost_message" class="form-control">{{$data['message']}}</textarea>
                                                @error('sale_lost_message')
                                                <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        @php($tre=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'transfer_rejected'])->first()->value)
                                        @php($data=json_decode($tre,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
