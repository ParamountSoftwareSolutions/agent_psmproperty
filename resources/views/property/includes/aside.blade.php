    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown @if (request()->routeIs('property.dashboard')) active @endif">
                <a href="{{ route('property.dashboard') }}" class="nav-link"><i data-feather="monitor"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="menu-header">Building Management</li>
            <li class="dropdown @if (request()->routeIs('property.building.index', 'property.building.create', 'property.building.edit', 'property.building.show')) active @endif">
                <a href="#" class="menu-toggle nav-link has-dropdown">
                    <i data-feather="home"></i><span>Building</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('property.building.index') }}">Building List</a></li>
                    {{--<li><a class="nav-link" href="{{ route('property.building.detail_form') }}">Add Building Details</a></li>--}}
                </ul>
            </li>
            <li class="dropdown @if (request()->routeIs('property.manager.index', 'property.manager.create', 'property.manager.edit', 'property.manager.show', 'property.sale_manager.index', 'property.sale_manager.create', 'property.sale_manager.edit', 'property.sale_manager.show')) active @endif">
                <a href="#" class="menu-toggle nav-link has-dropdown">
                    <i data-feather="user"></i><span>Manager</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('property.manager.index') }}">Manager List</a></li>
                    <li><a class="nav-link" href="{{ route('property.sale_manager.index') }}">Sale Manager List</a></li>
                    {{--<li><a class="nav-link" href="{{ route('property.building.detail_form') }}">Add Building Details</a></li>--}}
                </ul>
            </li>
            <li class="dropdown @if (request()->routeIs('property.sale.index', 'property.sale.update')) active @endif">
                <a href="#" class="menu-toggle nav-link has-dropdown">
...
<<<<<<< HEAD
            ...
            <li class="dropdown @if (request()->routeIs('property.employee.index', 'property.employee.update')) active @endif">
                <a href="#" class="menu-toggle nav-link has-dropdown">
...
>>>>>>> e73d3dd94bd58f71271ee38c5a091babc3d277f5
            ...
            <li class="dropdown @if (request()->routeIs('property.setting.*')) active @endif">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('property.setting.push_notification') }}">Push Notification</a></li>
                </ul>
            </li>
            <li class="dropdown @if (request()->routeIs('property.profile.index')) active @endif">
                <a href="#" class="menu-toggle nav-link has-dropdown">
                    <i data-feather="user"></i><span>Profile</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link " href="{{ route('property.profile.index') }}">Profile</a></li>
                </ul>
            </li>
        </ul>
    </aside>
