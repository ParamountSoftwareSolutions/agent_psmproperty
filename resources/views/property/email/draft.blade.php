                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('property_manager.email.view',['panel'=>Helpers::user_login_route()['panel'],'id'=>$data->id]) }}">{{ $data->to }}</a></td>
                                        <td>{{ $data->subject }}</td>
                                        <td>{{ $data->date }}</td>
                                        <td>
                                            ...
                                            <button type="button" data-url="{{ route('property_manager.email_destroy',['panel'=>Helpers::user_login_route()['panel'],'id'=>$data->id]) }}" data-token="{{ csrf_token() }}" title="Delete" class="btn btn-danger px-1 py-0 deleteBtn">
