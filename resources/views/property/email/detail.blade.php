                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="offset-lg-8 col-lg-1 px-0">
                                    <button type="button" class="btn btn-primary forward" title="{{$email->status == 'sent'? 'Forward' : 'Send'}}"
                                        style="margin-left: auto; display: block;">{{$email->status == 'sent'? 'Forward' : 'Send'}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- forward email modal -->
<form action="{{ route('property_manager.email.forward',['panel'=>Helpers::user_login_route()['panel'],'id'=>$email->id]) }}" method="post" id="callConnectForm">
    @csrf
