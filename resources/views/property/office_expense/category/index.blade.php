                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($category as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->name }}</td>
                                                <td>
                                                    <a href="{{ route('property.office_expense_category.edit',$data->id) }}"
                                                       class="btn btn-primary px-1 py-0" title="Edit">
                                                        <i class="fa fa-edit"></i>

                                                    </a>
                                                    <button type="button" data-url="{{ route('property.office_expense_category.destroy',$data->id) }}" data-token="{{ csrf_token() }}" title="Delete" class="btn btn-danger px-1 py-0 deleteBtn">
