                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">@if ($errors->any())
                            ...
                            @endif
                            <form method="post" action="{{ route('property.sale_manager.store') }}">
                                @csrf
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sale_manager as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property.sale_manager.edit', $data->id) }}"
                                                    ...
                                                    @if ($data->status == 0)
                                                        <a href="{{ route('property.sale_manager.activate', $data->id) }}"
                                                    ...
                                                    @else
                                                        <a href="{{ route('property.sale_manager.deactivate', $data->id) }}"
                                                           class="btn btn-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                 height="24" viewBox="0 0 24 24" fill="none"
                                                                 stroke="currentColor" stroke-width="2"
                                                    ...
                                                    @endif
                                                    <form
                                                        action="{{ route('property.sale_manager.destroy', $data->id) }}"
