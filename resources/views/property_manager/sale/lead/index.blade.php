                            ...
                            <div class="card-header-action">
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-md-5">
										...
										if (Auth::user()->hasRole("sale_person") == "1") { ?>
										  <div class="dropdown">
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($data->building_sale_history->count() != "0") { ?>
                                                    <?php if (!empty(json_decode($data->building_sale_history->last()->data)->date)) { ?>
                                                        <?php echo Carbon\Carbon::parse(json_decode($data->building_sale_history->last()->data)->date)->format('d/m/y  H:i A'); ?>
                                                    <?php  } ?>
                                                <?php  } else {  ?>
                                                    <?php echo Carbon\Carbon::parse($data->created_at)->format('d/m/y  H:i A') ?>
                                                <?php  }  ?>
                                            </td>
											 <td>
                                               <?php
                                                if ($data->building_sale_history->count() != "0") { ?>
                                                    <?php if (!empty($data->building_sale_history->last()->comment)) { ?>
                                                        <?php echo $data->building_sale_history->last()->comment; ?>
                                                    <?php  }  ?>
                                                <?php  }  ?>
                                            </td>
                                            <td>
												 <?php if (!Auth::user()->hasRole('sale_person')) {  ?>
