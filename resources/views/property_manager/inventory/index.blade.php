                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-8">
                                    <div class="row justify-content-end">
                                        ...
                                        <div class="col-md-2">
                                            <a href="{{ route('property_manager.inventory.create') }}" class="btn btn-primary"
                                               style="margin-left: auto; display: block;">Add New</a>
                                        </div>
                                    </div>

                                    <div class="card-header-action">
                                        <form action="{{ route('property_manager.inventory.filter') }}"
                                              class="filter_form"
                                              method="POST">
                                            @csrf
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($inventory as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_manager.inventory.edit',$data->id) }}"
                                                       class="btn btn-primary px-1 py-0" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form
                                                        action="{{ route('property_manager.inventory.destroy',$data->id) }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#statusForm').submit(function (e) {
                ...
                $.ajax({
                    url: "{{ route('property_manager.inventory_change_status') }}",
                    type: "POST",
                    data: formData,
                    success: function (data) {
                        hideLoader();
