                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Targets</h4>
                                <a href="{{ route('property_manager.assign_target', ['panel' => Helpers::user_login_route()['panel']]) }}" class="btn btn-info">Assign Target</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table text-center table-striped" id="table-1">
                                        ...
                                        @forelse($targets as $target)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_manager.edit_task',['panel' => Helpers::user_login_route()['panel'], 'id' => $target->id]) }}" class="btn btn-primary btn-sm px-1 py-0" title="Edit">
