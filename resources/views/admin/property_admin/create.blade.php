                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Property Admin Name</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <div class="control-label">What's app module</div>
                                            <label class="custom-switch mt-2 " style="margin-left: -2rem">
                                                <input type="hidden" name="key[whats_app_module]" value="0" class="custom-switch-input">
                                                <input type="checkbox" name="key[whats_app_module]" value="1" class="custom-switch-input">
