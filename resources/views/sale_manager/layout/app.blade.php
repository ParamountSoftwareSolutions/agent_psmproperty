...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        @include('sale_manager.includes.header')
        @include('admin.includes.aside')
        @yield('content')
        @include('sale_manager.includes.footer')
    </div>
</div>
<!-- General JS Scripts -->
...
<script>
    $(document).ready(function () {
        $(document).on('click', '#notification-mark-read',function () {
            $.ajax({
                url: "{{ url('sale-manager/notification/mark/read') }}",
                type: "GET",
                dataType: "json",
                success: function (data) {
                    /*console.log(data);*/
        ...
        $(document).on("click", "#notification-mark-single-read", function(e){
            ...
            console.log(id);
            $.ajax({
                url: "{{ url('sale-manager/notification/mark/single/read/') }}"+ '/' + id,
                type: "GET",
                dataType: "json",
                success: function (data) {
                    pauseAudio();
     ...
     //       $.ajax({
     //           url: "{{ url('sale-manager/notifications/latest') }}",
     //           type: "GET",
     //           dataType: "json",
     //           success: function (data) {
     //               console.log(data)
